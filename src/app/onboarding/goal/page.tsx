...
export default function OnboardingGoalPage() {
  ...
  return (
    <div className="min-h-dvh flex flex-col px-6 pt-10 pb-8 md:max-w-md md:mx-auto md:pt-16">
      ...
      <p className="text-[14px] text-cosfy-muted mb-6">Pick a goal — we&apos;ll tailor Cosfy around it.</p>
        ...
        {ONBOARDING_GOALS.map((g) => (
          <button
            ...
            className={cn(
              ...
              selected === g.value ? "border-cosfy-lime-deep" : "border-cosfy-border"
            )}
          >
      ...
      <PrimaryButton fullWidth disabled={!selected || isPending} onClick={handleContinue}>
        Continue
      </PrimaryButton>
    </div>
  );
