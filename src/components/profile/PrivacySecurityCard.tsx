...
const POINTS = [
  "All traffic to Cosfy is encrypted in transit (HTTPS/TLS), including every request to your bank SMS parser, Gmail import, and Kosh, your AI money coach.",
  ...
  "Questions you ask Kosh are sent to Google's Gemini API only to generate that answer, not to build a profile of you elsewhere.",
